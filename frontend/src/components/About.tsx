        ...
        >
          ...
          <div className="flex-1">
            ...
            <h2 className="text-4xl font-bold text-white mb-6 leading-tight">
              Cloud/Networking Student | NOC Technician<br />
            ...
            <p className="text-gray-400 leading-relaxed mb-8 max-w-lg">
              B.S. Cloud/Networking student at WGU and Obtaining my Masters in DevOps, Software Engineering. I work as a NOC Technician at an MSP,
              managing enterprise infrastructure and building PowerShell automation tools to solve
              real-world problems.
            </p>
            <div className="flex items-center gap-3 mb-8">
              <span className="w-2 h-2 rounded-full bg-green-400 animate-pulse" />
              <span className="text-gray-400 text-sm">Open to Cloud Engineering Roles</span>
            </div>
            <Link
              to="/about"
